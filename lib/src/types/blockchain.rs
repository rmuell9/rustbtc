...
impl Blockchain {
    ...
    pub fn block(&self) -> impl Iterator<Item = &Block> {
        self.blocks.iter()
    }
    ...
    pub fn add_to_mempool(&mut self, 
    ...
    // Remove transactions older than MAX_MEMPOOL_TRANSACTION AGE
    ...
    pub fn try_adjust_target(&mut self) {
        ...
        let new_target_str = new_target
            ...
            .split('.')
            .next()
            .expect("BIG: Expected a decimal point")
            .to_owned();
